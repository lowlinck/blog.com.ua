                ...
                <div class="row">
                    ...
                    <form action="{{route('admin.post.store')}}" method="POST" class="w-25">
                        ...
                        <div class="form-group">
                                ...
                                <label for="exampleInputEmail1">Введите содержимое контента</label>
                            <textarea type="text" class="form-control" name="content" placeholder="Введите название поста"></textarea>
                        </div>
